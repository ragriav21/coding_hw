...
allComparisonTable %>% 
  ...
  plot_ly(y = ~reserve, 
          ...
          type = "bar", 
          name = "Proportion of Matching Species in Reserves",
          orientation = "h") %>% 
  add_trace(x = ~proportion_matching_species_in_conservancy,
            name = "Proportion of Matching Species in Conservancy") %>% 
  layout(title = "Proportion of Matching Species per Reserve",
         xaxis = list(title = "Proportions (out of 1)", l = 50),
         yaxis = list(title = "Reserves", b = 20),
         barmode = "group",
         margin = list(l = 220, b = 80),
         legend = list(orientation = "h",
                       x = 0, b = 150))
             
               
  #              fill = factor(proportion_type))) +
