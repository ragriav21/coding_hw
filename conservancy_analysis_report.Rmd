...
margins <- list(l = 250, r = 0, b = 0, t = 50, pad = 0.5)
...
```{r Plots of Reserves with Closest Matches of Animal}
...
speciesCountsDisaggregated %>% 
  plot_ly(x = ~number_of_reserves, 
          y = ~category_number_of_species_found_in_n_or_fewer_reserves_plants,
          type = "scatter", 
          mode = "none",
          fill = "tozeroy",
  ...
  add_trace(y = ~category_number_of_species_found_in_n_or_fewer_reserves_animals,
            ...
            fill = "tonexty") %>% 
  layout(title = "Number of Rare or Unique Species in Conservancy",
         yaxis = list(title = "Number of Species Found", b = 20),
         xaxis = list(title = "Number of Reserves (X)"),
         autosize = FALSE,
         margin = margins,
         legend = list(orientation = "h",
                       x = 0, b = 0)) %>% 
